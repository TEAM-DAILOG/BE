...
export const unauthorizedResponseSchema: SwaggerSchema =
  createErrorResponseSchema(401, 'UNAUTHORIZED', '인증에 실패했습니다.');

export const internalServerErrorResponseSchema: SwaggerSchema =
...
export const categoryNotFoundResponseSchema: SwaggerSchema =
  createErrorResponseSchema(
    404,
    'CATEGORY_NOT_FOUND',
    '카테고리를 찾을 수 없습니다.',
...
export const scheduleNotFoundResponseSchema: SwaggerSchema =
  createErrorResponseSchema(
    404,
    'SCHEDULE_NOT_FOUND',
    '일정을 찾을 수 없습니다.',
...
export const scheduleItemSchema: SwaggerSchema = {
  type: 'object',
  required: [
    'scheduleId',
    'category',
...
const scheduleListDataSchema: SwaggerSchema = {
  type: 'object',
  required: ['schedules'],
  properties: { schedules: { type: 'array', items: scheduleItemSchema } },
};
...
const deleteScheduleDataSchema: SwaggerSchema = {
  type: 'object',
  required: ['scheduleId'],
  properties: { scheduleId: { type: 'integer', example: 1 } },
};

// 컨트롤러 클래스 레벨 Swagger

export function ScheduleControllerSwagger() {
...
export function GetSchedulesSwagger() {
  return applyDecorators(
    ApiOperation({
      summary: '전체 일정 목록 조회',
      description:
...
export function GetUpcomingSchedulesSwagger() {
  return applyDecorators(
    ApiOperation({
      summary: '가까운 일정 조회',
      description:
...
export function CreateScheduleSwagger() {
  return applyDecorators(
    ApiOperation({
      summary: '일정 등록',
      description:
          ...
          examples: {
            none: {
              ...
              value: {
                ...
                data: { scheduleId: 1, groupId: null, createdCount: 1 },
              },
            },
            multiple: {
              ...
              value: {
                resultType: 'SUCCESS',
                message: '일정 등록에 성공했습니다.',
                data: { scheduleId: null, groupId: 10, createdCount: 2 },
              },
            },
            period: {
              ...
              value: {
                resultType: 'SUCCESS',
                message: '일정 등록에 성공했습니다.',
                data: { scheduleId: null, groupId: 11, createdCount: 6 },
              },
            },
            weekly: {
              ...
              value: {
                resultType: 'SUCCESS',
                message: '일정 등록에 성공했습니다.',
                data: { scheduleId: null, groupId: 12, createdCount: 14 },
              },
            },
            monthly: {
              ...
              value: {
                resultType: 'SUCCESS',
                message: '일정 등록에 성공했습니다.',
                data: { scheduleId: null, groupId: 13, createdCount: 5 },
              },
            },
            yearly: {
              ...
              value: {
                resultType: 'SUCCESS',
                message: '일정 등록에 성공했습니다.',
                data: { scheduleId: null, groupId: 14, createdCount: 5 },
              },
            },
          },
        },
    ...
    ApiBody({
      schema: { $ref: getSchemaPath(CreateScheduleDto) },
      examples: {
        none: {
          summary: 'NONE — 단일 일정',
          value: {
...
export function UpdateScheduleSwagger() {
  return applyDecorators(
...
export function UpdateScheduleCompletionSwagger() {
  return applyDecorators(
    ApiOperation({
      summary: '일정 완료 상태 변경',
      description:
    ...
    ApiBody({
      required: true,
      schema: { $ref: getSchemaPath(UpdateScheduleCompletionDto) },
      examples: {
        complete: { summary: '일정 완료 처리', value: { isCompleted: true } },
        cancelCompletion: {
          summary: '일정 완료 취소',
...
export function DeleteScheduleSwagger() {
  return applyDecorators(
    ApiOperation({
      summary: '일정 삭제',
      description:
